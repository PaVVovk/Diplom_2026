...
integer, parameter :: dp = kind(1.0d0)
    ...
    logical :: repeat_flag
    real(dp) :: p, N, k_b, T_gas, t_max, t
    ! Ввод параметров
    print *, 'Введите количество интервалов M:'
    read *, M
    print *, 'Введите радиус трубки r0:'
    read *, r0
    print *, 'Введите параметр сгущения delta (отрицательный для сгущения к центру):'
    read *, delta
    print *, 'Введите числовой параметр'
    read *, sigma
    ...
    print *, 'r0 =', r0
    print *, 'delta =', delta
    print *, 'Начальный шаг h_first =', h_first
    print *, '========================================'
    print *, 'Основная сетка (узлы r_k):'
    do k = 0, M
        print '(I4, F12.6)', k, r_k(k)
    end do

    print *, '========================================'
    print *, 'Шаги основной сетки h_k:'
    do k = 0, M-1
        print '(I4, F12.6)', k, h_k(k)
    end do

    print *, '========================================'
    print *, 'Вспомогательная сетка (узлы r_{k+1/2}):'
    do k = 0, M-1
        print '(I4, F12.6)', k, r_half_k(k)
    end do

    print *, '========================================'
    print *, 'Шаги вспомогательной сетки ℏ_k:'
    do k = 1, M-1
    ...
    print *, '========================================'
    print *, 'Проверка: r(M) =', r_k(M), 'должно быть =', r0

    print *, 'Минимальный шаг h_k:', minval(h_k)
    if (minval(h_k) < 1e-30) then
        print *, 'ВНИМАНИЕ: очень маленький шаг!'
    end if
    ...
    print *, '========================================'
    do k = 0, M
       print *, 'Концентрация электронов n_e =', n_e_i(k)
    end do
    do k = 0, M
       print *, 'Концентрация электронов n_i =', n_i_i(k)
    end do
    do k = 0, M
       print *, 'Концентрация электронов n_e =', E_r_i(k)
    end do
